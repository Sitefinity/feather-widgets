...
namespace Telerik.Sitefinity.Frontend.Comments.Mvc.Models
{
    ...
    public interface ICommentsModel
    {
        ...
        /// <returns></returns>
        CommentsListViewModel GetCommentsListViewModel(CommentsInputModel commentsInputModel, bool useReviews);
        ...
        /// <returns></returns>
        CommentsCountViewModel GetCommentsCountViewModel(CommentsCountInputModel commentsCountInputModel, bool useReviews);
    }
}
