...
namespace Telerik.Sitefinity.Frontend.EmailCampaigns.Mvc.Models.UnsubscribeForm
{
    ...
    public class UnsubscribeFormModel : IUnsubscribeFormModel
    {
        ...
        /// <inheritDoc/>
        public bool Unsubscribe(string email, out string error)
        {
            error = string.Empty;
        ...
        private string widgetTitle = Res.Get<UnsubscribeFormResources>().UnsubscribeWidgetTitle;
        private string widgetDescription = Res.Get<UnsubscribeFormResources>().UnsubscribeWidgetDescription;
