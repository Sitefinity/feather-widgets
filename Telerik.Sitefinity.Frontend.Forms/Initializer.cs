...
namespace Telerik.Sitefinity.Frontend.Forms
{
    ...
    public static class Initializer
    {
        ...
        private static void AddFieldsToToolbox()
        {
            ...
            Initializer.RegisterToolboxItem(section, "MvcPageBreak", "Form navigation", "Telerik.Sitefinity.Frontend.Forms.Mvc.Controllers.NavigationFieldController", "sfFormNavIcn sfMvcIcn");
