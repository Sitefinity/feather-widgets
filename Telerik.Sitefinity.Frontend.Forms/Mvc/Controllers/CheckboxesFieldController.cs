...
namespace Telerik.Sitefinity.Frontend.Forms.Mvc.Controllers
{
    ...
    public class CheckboxesFieldController : Controller, IFormFieldController<ICheckboxesFieldModel>
    {
        ...
        public virtual ICheckboxesFieldModel Model
        {
            get
            {
                if (this.model == null)
        ...
        public virtual ActionResult Index(object value = null)
        {
            ...
            if (this.DisplayMode == FieldDisplayMode.Read)
                templateName = CheckboxesFieldController.ReadTemplateNamePrefix + this.ReadTemplateName;
            else
                templateName = CheckboxesFieldController.WriteTemplateNamePrefix + this.WriteTemplateName;
