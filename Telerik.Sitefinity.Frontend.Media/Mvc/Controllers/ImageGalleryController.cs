...
namespace Telerik.Sitefinity.Frontend.Media.Mvc.Controllers
{
    ...
    public class ImageGalleryController : Controller, IContentLocatableView, IRouteMapper
    {
        ...
        {
            var itemIndex = this.ParseToNullableInt32(this.GetQueryStringItemIndex());
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual string GetQueryStringItemIndex()
        {
            return Request.QueryString["itemIndex"];
        }
