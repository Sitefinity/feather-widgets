...
namespace Feather.Widgets.TestUI.Framework.Framework.Wrappers.Backend
{
    public class WidgetDesignerWrapper : BaseWrapper
    {
        ...
        /// <summary>
        /// Select weeks starts on "Monday"
        /// </summary>
        public void SelectWeekStartsOnMonday()
        {
            HtmlInputRadioButton selectWeekStartsOnMonday = this.EM.Widgets.WidgetDesignerCalendarScreen.WeekStartsOnMonday
                .AssertIsPresent("Weeks starts on Monday");
            selectWeekStartsOnMonday.Click();
        }

        /// <summary>
        /// Select weeks starts on "Sunday"
        /// </summary>
        public void SelectWeekStartsOnSunday()
        {
