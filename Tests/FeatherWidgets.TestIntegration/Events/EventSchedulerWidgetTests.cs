...
//////            this.AssertEvent(widgetId, DateTime.MinValue, DateTime.MaxValue, EventsManager.GetManager().GetEventsOccurrences(EventsManager.GetManager().GetEvents(), DateTime.MinValue, DateTime.Now.AddYears(4000)).Where(p => p.Event.LanguageData.Where(t => t.Language == bulgarian.Name).LongCount() > 0).Count());
//////        }
...
//////            this.AssertCalendar(widgetId, DateTime.MinValue, DateTime.MaxValue, 2);
//////        }
...
//////        {
//////            var page = PageManager.GetManager().GetPageData(pageId);
