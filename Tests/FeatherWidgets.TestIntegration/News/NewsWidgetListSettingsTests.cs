...
namespace FeatherWidgets.TestIntegration.News
{
    ...
    public class NewsWidgetListSettingsTests
    {
        ...
        public void NewsWidget_VerifySortNewsPublicationDateDescending()
        {
            ...
            var newsItems = newsManager.GetNewsItems().Where<NewsItem>(ni => ni.Status == Telerik.Sitefinity.GenericContent.Model.ContentLifecycleStatus.Master).OrderBy(n => n.PublicationDate);
