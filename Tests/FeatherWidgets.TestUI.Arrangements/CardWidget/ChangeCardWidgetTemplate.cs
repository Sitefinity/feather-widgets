...
{
    /// <summary>
    /// ChangeCardWidgetTemplate arrangement class.
    /// </summary>
    public class ChangeCardWidgetTemplate : TestArrangementBase
    {
         /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        public void SetUp()
        {
            ...
            ServerOperationsFeather.Pages().AddCardWidgetToPage(pageId, "Contentplaceholder1");
