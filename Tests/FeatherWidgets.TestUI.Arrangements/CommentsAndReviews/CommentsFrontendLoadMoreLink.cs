...
namespace FeatherWidgets.TestUI.Arrangements
{
    ...
    /// </summary>
    public class CommentsFrontendLoadMoreLink : TestArrangementBase
    {
        /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        public void SetUp()
        {
            ...
            ServerOperations.Comments().CreatePublishedComments(50, this.key, ThreadType, newsId, NewsTitle, CommentMessage);
        }
