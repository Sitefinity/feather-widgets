...
{
    public class VerifyAllDayEventsInOneDay_SchedulerView : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
        ...
        private readonly DateTime event1End = new DateTime(2016, 1, 11, 0, 0, 0, DateTimeKind.Utc);
        ...
        private readonly DateTime event2End = new DateTime(2016, 4, 11, 0, 0, 0, DateTimeKind.Utc);
