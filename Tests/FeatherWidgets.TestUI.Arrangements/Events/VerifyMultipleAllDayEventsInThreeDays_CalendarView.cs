...
{
    public class VerifyMultipleAllDayEventsInThreeDays_CalendarView : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
        ...
        public void OnBeforeTestsStarts()
        {
            ...
            var event1End = this.event1Start.AddDays(3);
            ...
            var event2End = this.event2Start.AddDays(3);
