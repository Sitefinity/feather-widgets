...
{
    /// <summary>
    /// Executes Server Side operations for CreateMultipleNormalEventsInThreeDays_CalendarView UI Test.
    /// </summary>
    public class VerifyMultipleNormalEventsInThreeDays_CalendarView : TestArrangementBase
    {
         /// <summary>
        /// Creates an Event.
