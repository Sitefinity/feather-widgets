...
{
    /// <summary>
    /// Executes Server Side operations for VerifyPastCurrentUpcomingEvents_Calendar_HybridPage_Day_View UI Test.
    /// </summary>
    public class VerifyPastCurrentUpcomingEvents_Calendar_HybridPage_Day_View : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
