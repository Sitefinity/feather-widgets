...
{
    /// <summary>
    /// Executes Server Side operations for VerifyPastCurrentUpcomingEvents_Calendar_HybridPage_Month_View UI Test.
    /// </summary>
    public class VerifyPastCurrentUpcomingEvents_Calendar_HybridPage_Month_View : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
