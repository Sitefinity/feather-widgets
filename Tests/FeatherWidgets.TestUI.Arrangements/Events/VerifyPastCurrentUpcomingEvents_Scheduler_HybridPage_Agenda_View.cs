...
{
    /// <summary>
    /// Executes Server Side operations for VerifyPastCurrentUpcomingEvents_Scheduler_HybridPage_Agenda_View UI Test.
    /// </summary>
    public class VerifyPastCurrentUpcomingEvents_Scheduler_HybridPage_Agenda_View : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
