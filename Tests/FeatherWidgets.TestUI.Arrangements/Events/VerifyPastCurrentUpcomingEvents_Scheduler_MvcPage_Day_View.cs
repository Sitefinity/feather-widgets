...
{
    /// <summary>
    /// Executes Server Side operations for VerifyPastCurrentUpcomingEvents_Scheduler_MvcPage_Day_View UI Test.
    /// </summary>
    public class VerifyPastCurrentUpcomingEvents_Scheduler_MvcPage_Day_View : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
