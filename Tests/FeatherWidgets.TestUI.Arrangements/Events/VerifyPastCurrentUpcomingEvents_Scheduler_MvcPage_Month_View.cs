...
{
    /// <summary>
    /// Executes Server Side operations for VerifyPastCurrentUpcomingEvents_Scheduler_MvcPage_Month_View UI Test.
    /// </summary>
    public class VerifyPastCurrentUpcomingEvents_Scheduler_MvcPage_Month_View : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
