...
{
    /// <summary>
    /// Executes Server Side operations for VerifyPastCurrentUpcomingEvents_Scheduler_WorkWeekView_HybridPage UI Test.
    /// </summary>
    public class VerifyPastCurrentUpcomingEvents_Scheduler_WorkWeekView_HybridPage : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
