...
{
    /// <summary>
    /// Executes Server Side operations for VerifyRecurrentAllDayEventsWithNoEndDate_SchedulerView UI Test.
    /// </summary>
    public class VerifyRecurrentAllDayEventsWithNoEndDate_SchedulerView : TestArrangementBase
    {
        /// <summary>
        /// Creates an Event.
