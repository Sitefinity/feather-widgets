...
{
    /// <summary>
    /// AddFieldsToHeaderAndFooter arrangement class.
    /// </summary>
    public class AddFieldsToHeaderAndFooter : TestArrangementBase
    {
        /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        public void SetUp()
        {
            var formId = ServerOperationsFeather.Forms().CreateFormWithWidgets(new FormFieldType[] { FormFieldType.TextField }, FormName);
