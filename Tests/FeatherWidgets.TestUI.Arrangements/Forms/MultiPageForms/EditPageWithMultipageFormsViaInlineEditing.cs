...
{
    /// <summary>
    /// EditPageWithMultipageFormsViaInlineEditing arrangement class.
    /// </summary>
    public class EditPageWithMultipageFormsViaInlineEditing : TestArrangementBase
    {
        /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        public void SetUp()
        {
            ...
            ServerOperationsFeather.Pages().AddContentBlockWidgetToPage(pageId, Content, PlaceHolderId);
        }
