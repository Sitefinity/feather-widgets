...
{
    /// <summary>
    /// UserIsNotAllowedToSubmit arrangement class.
    /// </summary>
    public class UserIsNotAllowedToSubmit : TestArrangementBase
    {
        /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        public void SetUp()
        {
            ...
            List<FormFieldType> formBodyControls = new List<FormFieldType>() { FormFieldType.FileField, FormFieldType.PageBreak, FormFieldType.SubmitButton };
