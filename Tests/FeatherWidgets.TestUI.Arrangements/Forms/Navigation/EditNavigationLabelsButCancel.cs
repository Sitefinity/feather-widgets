...
{
    /// <summary>
    /// EditNavigationLabelsButCancel arrangement class.
    /// </summary>
    public class EditNavigationLabelsButCancel : TestArrangementBase
    {
        /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        public void SetUp()
        {
            ...
            List<FormFieldType> formBodyControls = new List<FormFieldType>() { FormFieldType.TextField, FormFieldType.PageBreak, FormFieldType.TextField, FormFieldType.SubmitButton };
