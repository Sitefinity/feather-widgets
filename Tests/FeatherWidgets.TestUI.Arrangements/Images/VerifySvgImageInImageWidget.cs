...
{
    /// <summary>
    /// Upload Svg Image, create MVC page with Image widget
    /// </summary>
    public class VerifySvgImageInImageWidget : TestArrangementBase
    {
        /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        public void SetUp()
        {
            ...
            ServerOperationsFeather.Pages().AddImageWidgetToPage(pageId);
