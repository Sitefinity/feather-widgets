...
namespace FeatherWidgets.TestUI.Arrangements
{
    ...
    /// </summary>
    public class NavigationWidgetOnBootstrapTemplate : ITestArrangement
    {
        /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        {
            return Path.Combine(FeatherServerOperations.ResourcePackages().SfPath, "ResourcePackages", "Bootstrap", "MVC", "Views", "Layouts", fileName);          
        }
