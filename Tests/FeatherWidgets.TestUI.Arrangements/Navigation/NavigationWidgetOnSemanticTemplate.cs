...
namespace FeatherWidgets.TestUI.Arrangements
{
    ...
    /// </summary>
    public class NavigationWidgetOnSemanticTemplate : ITestArrangement
    {
        /// <summary>
        /// Server side set up.
        /// </summary>
        ...
        {
            return Path.Combine(FeatherServerOperations.ResourcePackages().SfPath, "ResourcePackages", "SemanticUI", "MVC", "Views", "Layouts", fileName);          
        }
