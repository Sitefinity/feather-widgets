...
{
    /// <summary>
    /// ChangeAdvancedSettingsOfCardWidget test class.
    /// </summary>
    [TestClass]
    public class ChangeAdvancedSettingsOfCardWidget_ : FeatherTestCase
    {
        /// <summary>
        ...
        public void ChangeAdvancedSettingsOfCardWidget()
        {
            ...
            BATFeather.Wrappers().Backend().Card().CardWrapper().FillHeadingTextInAdvancedSettings(HeadingText);
