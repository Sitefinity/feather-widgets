...
{
    /// <summary>
    /// DeactivateFeatherAndVerifyFormsMvcOption test class.
    /// </summary>
    [TestClass]
    public class DeactivateFeatherAndVerifyFormsMvcOption_ : FeatherTestCase
    {
        /// <summary>
        /// UI test DeactivateFeatherAndVerifyFormsMvcOption
        /// </summary>
        [TestMethod,
