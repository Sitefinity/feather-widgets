...
{
    /// <summary>
    /// VerifyNoLimitAndPaginationListSettingsOnFrontendPageForDocumentsListWidget_ test class.
    /// </summary>
    [TestClass]
    public class VerifyNoLimitAndPaginationListSettingsOnFrontendPageForDocumentsListWidget_ : FeatherTestCase
    {
        /// <summary>
        /// UI test VerifyNoLimitAndPaginationListSettingsOnFrontendPageForDocumentsListWidget
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam7),
        TestCategory(FeatherTestCategories.PagesAndContent), 
        TestCategory(FeatherTestCategories.DocumentsList)]
        public void VerifyNoLimitAndPaginationListSettingsOnFrontendPageForDocumentsListWidget()
        {
            ...
            Assert.IsTrue(BATFeather.Wrappers().Frontend().DocumentsList().DocumentsListWrapper().AreDocumentTitlesPresentOnThePageFrontend(new string[] { DocumentTitles5, DocumentTitles4, DocumentTitles3, DocumentTitles2, DocumentTitles1 }));
            BAT.Macros().NavigateTo().Pages(this.Culture);
        }
