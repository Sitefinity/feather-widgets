...
namespace FeatherWidgets.TestUI.TestCases.DocumentsList
{
    ...
    public class VerifyNoLimitAndPaginationListSettingsOnFrontendPageForDocumentsListWidget_ : FeatherTestCase
    {
        ...
        public void VerifyNoLimitAndPaginationListSettingsOnFrontendPageForDocumentsListWidget()
        {
            ...
            Assert.IsTrue(BATFeather.Wrappers().Frontend().CommonWrapper().AreTitlesPresentOnThePageFrontend(new string[] { DocumentTitles5, DocumentTitles4, DocumentTitles3, DocumentTitles2, DocumentTitles1 }));
            BAT.Macros().NavigateTo().Pages(this.Culture);
        }
