...
{
    /// <summary>
    /// EditSelectedTagInDynamicWidget test class.
    /// </summary>
    [TestClass]
    public class EditSelectedTagInDynamicWidget_ : FeatherTestCase
    {
        /// <summary>
        /// UI test EditSelectedTagInDynamicWidget
        /// </summary>
        [TestMethod,
        Microsoft.VisualStudio.TestTools.UnitTesting.Owner("Feather Team"),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.DynamicWidgets)]
        public void EditSelectedTagInDynamicWidget()
        {
