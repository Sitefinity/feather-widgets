...
namespace FeatherWidgets.TestUI.TestCases.Events
{
    ...
    public class FilterUpcomingAndCurrentEventOnPage_ : FeatherTestCase
    {
        ...
        public void FilterUpcomingAndCurrentEventOnPage()
        {
            ...
            Assert.IsFalse(BATFeather.Wrappers().Frontend().Events().EventsWrapper().AreEventTitlesPresentOnThePageFrontend(new string[] { EventsTestsCommon.BasePastInFourDaysEventTitle, EventsTestsCommon.BasePastInTwoDaysEventTitle }));
        }
        ...
        private readonly string[] eventTitles = new string[] { EventsTestsCommon.BaseAllDayEventTitle, EventsTestsCommon.BaseUpcomingInOneDayEventTitle, EventsTestsCommon.BaseUpcomingInThreeDaysEventTitle, EventsTestsCommon.BaseRepeatEventTitle };
