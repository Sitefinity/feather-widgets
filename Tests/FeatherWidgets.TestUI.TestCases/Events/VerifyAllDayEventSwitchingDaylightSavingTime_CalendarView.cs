...
{
    /// <summary>
    /// Create all day event switching daylight saving time.
    /// Verify that the event is displayed correctly in Scheduler.
    /// </summary>
    [TestClass]
    public class VerifyAllDayEventSwitchingDaylightSavingTime_CalendarView_ : FeatherTestCase
    {
        // <summary>
        /// Test Method that provides test steps for VerifyAllDayEventSwitchingDaylightSavingTime_CalendarView UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyAllDayEventSwitchingDaylightSavingTime_CalendarView()
        {
        ...
        private readonly DateTime event1End = new DateTime(2016, 4, 10, 0, 0, 0);
