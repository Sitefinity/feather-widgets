...
namespace FeatherWidgets.TestUI.TestCases.Events
{
    ...
    /// </summary>
    [TestClass]
    public class VerifyAllDayEventsInOneDay_CalendarView_ : FeatherTestCase
    {
        /// <summary>
        /// Test Method that provides test steps for VerifyAllDayEventsInOneDay_CalendarView_ UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyAllDayEventsInOneDay_CalendarView()
        {
