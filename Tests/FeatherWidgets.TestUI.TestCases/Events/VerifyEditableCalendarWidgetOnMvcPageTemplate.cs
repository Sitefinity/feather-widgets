...
{
    /// <summary>
    /// Create a few events and a pure MVC page template with editable Calendar Widget.
    /// Create a page based on that template.
    /// View page and verify events visibility.
    /// </summary>
    [TestClass]
    public class VerifyEditableCalendarWidgetOnMvcPageTemplate_ : FeatherTestCase
    {
        /// <summary>
        /// Test Method that provides test steps for VerifyEditableCalendarWidgetOnMvcPageTemplate_ UI Test.
        /// </summary>
        [TestMethod,
