...
{
    /// <summary>
    /// Create a few events and a Mvc page template with editable Calendar Widget.
    /// Create a page based on that template.
    /// Edit Calendar widget and publish the page.
    /// Verify events on page.
    /// </summary>
    [TestClass]
    public class VerifyModifiedEditableCaledarWidgetOnMvcPage_ : FeatherTestCase
    {
        /// <summary>
        /// Test Method that provides test steps for VerifyModifiedEditableCaledarWidgetOnMvcPage_ UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyModifiedEditableCaledarWidgetOnMvcPage()
        {
