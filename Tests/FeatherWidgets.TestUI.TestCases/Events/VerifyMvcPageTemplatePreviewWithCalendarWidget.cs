...
namespace FeatherWidgets.TestUI.TestCases.Events
{
    ...
    /// </summary>
    [TestClass]
    public class VerifyMvcPageTemplatePreviewWithCalendarWidget_ : FeatherTestCase
    {
         /// <summary>
        /// Test Method that provides test steps for VerifyMvcPageTemplatePreviewWithCalendarWidget_ UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyMvcPageTemplatePreviewWithCalendarWidget()
        {
