...
{
    /// <summary>
    /// Create a few events and a pure Mvc page template with Calendar Widget.
    /// Create a page based on the created template.
    /// Verify events visibility on page view.
    /// </summary>
    [TestClass]
    public class VerifyPageWithMvcPageTemplateContainingCalendarWidget_ : FeatherTestCase
    {
        /// <summary>
        /// Test Method that provides test steps for VerifyPageWithMvcPageTemplateContainingCalendarWidget_ UI Test.
        /// </summary>
        [TestMethod,
