...
namespace FeatherWidgets.TestUI.TestCases.Events
{
    ...
    /// </summary>
    [TestClass]
    public class VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_ : FeatherTestCase
    {
          /// <summary>
        /// Test Method that provides test steps for VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Month_View UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Month_View()
        {
        ...
        /// <summary>
        /// Test Method that provides test steps for VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Day_View UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Day_View()
        {
        ...
        /// <summary>
        /// Test Method that provides test steps for VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Week_View UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Week_View()
        {
        ...
        /// <summary>
        /// Test Method that provides test steps for VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Agenda_View UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Agenda_View()
        {
        ...
        /// <summary>
        /// Test Method that provides test steps for VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Timeline_View UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyPastCurrentUpcomingEvents_Calendar_MvcPage_Timeline_View()
        {
        ...
        /// <summary>
        /// Verifies event title, start and end date in calenadar's view
        /// </summary>
        /// <param name="eventTitle">Event Title</param>
