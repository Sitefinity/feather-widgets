...
namespace FeatherWidgets.TestUI.TestCases.Events
{
    ...
    /// </summary>
   [TestClass]
    public class VerifyPastCurrentUpcomingEvents_Scheduler_WorkWeekView_MvcPage_ : FeatherTestCase
    {
       /// <summary>
        /// Test Method that provides test steps for VerifyPastCurrentUpcomingEvents_Scheduler_WorkWeekView_MvcPage_ UI Test.
       /// </summary>
       [TestMethod,
       Owner(FeatherTeams.SitefinityTeam8),
       TestCategory(FeatherTestCategories.PagesAndContent),
       TestCategory(FeatherTestCategories.Events)]
       public void VerifyPastCurrentUpcomingEvents_Scheduler_WorkWeekView_MvcPage()
       {
