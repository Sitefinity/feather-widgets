...
namespace FeatherWidgets.TestUI.TestCases.Events
{
    ...
    /// </summary>
    [TestClass]
    public class VerifyRecurrentAllDayEventsWithNoEndDate_SchedulerView_ : FeatherTestCase
    {
        /// <summary>
        /// Test Method that provides test steps for VerifyRecurrentAllDayEventsWithNoEndDate_SchedulerView_ UI Test.
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam8),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Events)]
        public void VerifyRecurrentAllDayEventsWithNoEndDate_SchedulerView()
        {
