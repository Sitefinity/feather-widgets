...
{
    /// <summary>
    /// DuplicateAndDeleteOfCaptchaField test class.
    /// </summary>
    [TestClass]
    public class DuplicateAndDeleteOfCaptchaField_ : FeatherTestCase
    {
        /// <summary>
        /// UI test DuplicateAndDeleteOfCaptchaField
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void DuplicateAndDeleteOfCaptchaField()
        {
