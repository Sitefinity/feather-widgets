...
{
    /// <summary>
    /// EditPageWithCaptchaFieldViaInlineEditing test class.
    /// </summary>
    [TestClass]
    public class EditPageWithCaptchaFieldViaInlineEditing_ : FeatherTestCase
    {
        /// <summary>
        /// UI test EditPageWithCaptchaFieldViaInlineEditing
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void EditPageWithCaptchaFieldViaInlineEditing()
        {
