...
{
    /// <summary>
    /// ChangeAdvancedSettingsOfSectionHeaderFieldAndSetCssClass test class.
    /// </summary>
    [TestClass]
    public class ChangeAdvancedSettingsOfSectionHeaderFieldAndSetCssClass_ : FeatherTestCase
    {
        /// <summary>
        /// UI test ChangeAdvancedSettingsOfSectionHeaderFieldAndSetCssClass
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void ChangeAdvancedSettingsOfSectionHeaderFieldAndSetCssClass()
        {
