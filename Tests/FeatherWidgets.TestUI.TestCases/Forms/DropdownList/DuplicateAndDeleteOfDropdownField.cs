...
{
    /// <summary>
    /// DuplicateAndDeleteOfDropdownField test class.
    /// </summary>
    [TestClass]
    public class DuplicateAndDeleteOfDropdownField_ : FeatherTestCase
    {
        /// <summary>
        /// UI test DuplicateAndDeleteOfDropdownField
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void DuplicateAndDeleteOfDropdownField()
        {
