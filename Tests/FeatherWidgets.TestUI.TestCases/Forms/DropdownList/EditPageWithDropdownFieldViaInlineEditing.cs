...
{
    /// <summary>
    /// EditPageWithDropdownFieldViaInlineEditing test class.
    /// </summary>
    [TestClass]
    public class EditPageWithDropdownFieldViaInlineEditing_ : FeatherTestCase
    {
        /// <summary>
        /// UI test EditPageWithDropdownFieldViaInlineEditing
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void EditPageWithDropdownFieldViaInlineEditing()
        {
