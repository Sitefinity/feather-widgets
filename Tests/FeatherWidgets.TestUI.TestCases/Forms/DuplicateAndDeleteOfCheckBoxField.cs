...
{
    /// <summary>
    /// DuplicateAndDeleteOfCheckBoxField test class.
    /// </summary>
    [TestClass]
    public class DuplicateAndDeleteOfCheckBoxField_ : FeatherTestCase
    {
        /// <summary>
        /// UI test DuplicateAndDeleteOfCheckBoxField
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void DuplicateAndDeleteOfCheckBoxField()
        {
