...
{
    /// <summary>
    /// DuplicateAndDeleteOfFileUploadField test class.
    /// </summary>
    [TestClass]
    public class DuplicateAndDeleteOfFileUploadField_ : FeatherTestCase
    {
        /// <summary>
        /// UI test DuplicateAndDeleteOfFileUploadField
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void DuplicateAndDeleteOfFileUploadField()
        {
