...
{
    /// <summary>
    /// DuplicateAndDeleteOfSectionHeaderField test class.
    /// </summary>
    [TestClass]
    public class DuplicateAndDeleteOfSectionHeaderField_ : FeatherTestCase
    {
        /// <summary>
        /// UI test DuplicateAndDeleteOfSectionHeaderField
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void DuplicateAndDeleteOfSectionHeaderField()
        {
