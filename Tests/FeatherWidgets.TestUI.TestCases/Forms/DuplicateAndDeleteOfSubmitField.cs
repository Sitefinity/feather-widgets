...
{
    /// <summary>
    /// DuplicateAndDeleteOfSubmitField test class.
    /// </summary>
    [TestClass]
    public class DuplicateAndDeleteOfSubmitField_ : FeatherTestCase
    {
        /// <summary>
        /// UI test DuplicateAndDeleteOfSubmitField
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void DuplicateAndDeleteOfSubmitField()
        {
