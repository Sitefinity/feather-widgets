...
{
    /// <summary>
    /// EditPageWithFileUploadFieldViaInlineEditing test class.
    /// </summary>
    [TestClass]
    public class EditPageWithFileUploadFieldViaInlineEditing_ : FeatherTestCase
    {
        /// <summary>
        /// UI test EditPageWithFileUploadFieldViaInlineEditing
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void EditPageWithFileUploadFieldViaInlineEditing()
        {
