...
{
    /// <summary>
    /// EditPageWithParagraphTextboxFieldViaInlineEditing test class.
    /// </summary>
    [TestClass]
    public class EditPageWithParagraphTextboxFieldViaInlineEditing_ : FeatherTestCase
    {
        /// <summary>
        /// UI test EditPageWithParagraphTextboxFieldViaInlineEditing
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void EditPageWithParagraphTextboxFieldViaInlineEditing()
        {
