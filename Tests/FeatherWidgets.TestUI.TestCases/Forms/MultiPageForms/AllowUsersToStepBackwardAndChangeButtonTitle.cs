...
{
    /// <summary>
    /// AllowUsersToStepBackwardAndChangeButtonTitle_ test class.
    /// </summary>
    [TestClass]
    public class AllowUsersToStepBackwardAndChangeButtonTitle_ : FeatherTestCase
    {
        /// <summary>
        /// UI test AllowUsersToStepBackwardAndChangeButtonTitle
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void AllowUsersToStepBackwardAndChangeButtonTitle()
        {           
