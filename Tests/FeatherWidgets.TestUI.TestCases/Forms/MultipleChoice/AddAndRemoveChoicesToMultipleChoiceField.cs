...
{
    /// <summary>
    /// AddAndRemoveChoicesToMultipleChoiceField test class.
    /// </summary>
    [TestClass]
    public class AddAndRemoveChoicesToMultipleChoiceField_ : FeatherTestCase
    {
        /// <summary>
        /// UI test AddAndRemoveChoicesToMultipleChoiceField
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.FeatherTeam),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void AddAndRemoveChoicesToMultipleChoiceField()
        {
            ...
            BATFeather.Wrappers().Frontend().Forms().FormsWrapper().SelectRadioButton(NewChoice);
            ...
            BAT.Macros().NavigateTo().CustomPage("~/" + PageName.ToLower(), true, this.Culture);
            BATFeather.Wrappers().Frontend().Forms().FormsWrapper().SelectOtherRadioButton();
            BATFeather.Wrappers().Frontend().Forms().FormsWrapper().SetTextToOtherChoice(OtherChoiceText);
            BATFeather.Wrappers().Frontend().Forms().FormsWrapper().SubmitForm();
