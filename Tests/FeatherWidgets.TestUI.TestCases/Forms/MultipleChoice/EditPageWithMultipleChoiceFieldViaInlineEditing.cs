...
{
    /// <summary>
    /// EditPageWithMultipleChoiceFieldViaInlineEditing test class.
    /// </summary>
    [TestClass]
    public class EditPageWithMultipleChoiceFieldViaInlineEditing_ : FeatherTestCase
    {
        /// <summary>
        /// UI test EditPageWithMultipleChoiceFieldViaInlineEditing
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void EditPageWithMultipleChoiceFieldViaInlineEditing()
        {
