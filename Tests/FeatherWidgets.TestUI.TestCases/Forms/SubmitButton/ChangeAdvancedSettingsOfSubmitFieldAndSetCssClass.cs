...
{
    /// <summary>
    /// ChangeAdvancedSettingsOfSubmitFieldAndSetCssClass test class.
    /// </summary>
    [TestClass]
    public class ChangeAdvancedSettingsOfSubmitFieldAndSetCssClass_ : FeatherTestCase
    {
        /// <summary>
        /// UI test ChangeAdvancedSettingsOfSubmitFieldAndSetCssClass
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void ChangeAdvancedSettingsOfSubmitFieldAndSetCssClass()
        {
