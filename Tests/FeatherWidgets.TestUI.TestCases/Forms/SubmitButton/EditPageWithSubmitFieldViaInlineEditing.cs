...
{
    /// <summary>
    /// EditPageWithSubmitFieldViaInlineEditing test class.
    /// </summary>
    [TestClass]
    public class EditPageWithSubmitFieldViaInlineEditing_ : FeatherTestCase
    {
        /// <summary>
        /// UI test EditPageWithSubmitFieldViaInlineEditing
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam6),
        TestCategory(FeatherTestCategories.Bootstrap),
        TestCategory(FeatherTestCategories.Forms)]
        public void EditPageWithSubmitFieldViaInlineEditing()
        {
