...
{
    /// <summary>
    /// ViewFormWithCheckboxesFieldOnPageAndVerifyResponseInBackend test class.
    /// </summary>
    [TestClass]
    public class ViewFormWithCheckboxesFieldOnPageAndVerifyResponseInBackend_ : FeatherTestCase
    {
        /// <summary>
        ...
        public void ViewFormWithCheckboxesFieldOnPageAndVerifyResponseInBackend()
        {
            ...
            BAT.Wrappers().Backend().Forms().FormsContentScreen().AddWidget(Telerik.Sitefinity.TestUI.Framework.Wrappers.Backend.Forms.FormWidgetNames.Checkboxes);
