...
{
    /// <summary>
    /// SelectAllPublishedImagesWithOverlayGalleryTemplate test class.
    /// </summary>
    [TestClass]
    public class SelectAllPublishedImagesWithOverlayGalleryTemplate_ : FeatherTestCase
    {
        /// <summary>
        ...
        public void SelectAllPublishedImagesWithOverlayGalleryTemplate()
        {
            ...
            BATFeather.Wrappers().Backend().ImageGallery().ImageGalleryWrapper().SelectOptionInListTemplateSelector(OverlayGalleryTemplate);
