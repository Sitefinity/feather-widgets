...
{
    /// <summary>
    /// VerifyNoLimitAndPaginationListSettingsOnFrontendPageForImageGalleryWidget_ test class.
    /// </summary>
    [TestClass]
    public class VerifyNoLimitAndPaginationListSettingsOnFrontendPageForImageGalleryWidget_ : FeatherTestCase
    {
        /// <summary>
        /// UI test VeVerifyNoLimitAndPaginationListSettingsOnFrontendPageForImageGalleryWidget
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam7),
        TestCategory(FeatherTestCategories.PagesAndContent), 
        TestCategory(FeatherTestCategories.ImageGallery)]
        public void VerifyNoLimitAndPaginationListSettingsOnFrontendPageForImageGalleryWidget()
        {
