...
{
    /// <summary>
    /// VerifyPagingOnFrontendPageForImageGalleryWidget_ test class.
    /// </summary>
    [TestClass]
    public class VerifyPagingOnFrontendPageForImageGalleryWidget_ : FeatherTestCase
    {
        /// <summary>
        /// UI test VerifyPagingOnFrontendPageForImageGalleryWidget
        /// </summary>
        [TestMethod,
        ...
        public void VerifyPagingOnFrontendPageForImageGalleryWidget()
        {
            ...
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsNotPresent(ImageAltText3);
            ...
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsPresent(ImageAltText2);
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsNotPresent(ImageAltText5);
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsNotPresent(ImageAltText4);
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsNotPresent(ImageAltText1);
            BATFeather.Wrappers().Frontend().CommonWrapper().NavigateToPageUsingPager("3", 3);
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsPresent(ImageAltText1);
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsNotPresent(ImageAltText5);
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsNotPresent(ImageAltText4);
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsNotPresent(ImageAltText3);
            BATFeather.Wrappers().Frontend().ImageGallery().ImageGalleryWrapper().VerifyImageIsNotPresent(ImageAltText2);
