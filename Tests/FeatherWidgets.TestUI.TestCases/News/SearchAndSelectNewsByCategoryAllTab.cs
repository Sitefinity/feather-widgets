...
namespace FeatherWidgets.TestUI
{
    ...
    public class SearchAndSelectNewsByCategoryAllTab_ : FeatherTestCase
    {
        ...
        public void SearchAndSelectNewsByCategoryAllTab()
        {
            ...
            BATFeather.Wrappers().Backend().News().NewsWidgetEditContentScreenWrapper().CheckBreadcrumbAfterSearchInHierarchicalSelector(breadcrumbName, breadcrumbFullName);
            ...
            BATFeather.Wrappers().Backend().News().NewsWidgetEditContentScreenWrapper().VerifySelectedItemsFromHierarchicalSelector(new[] { "Category0 > Category1 > Category2 > Category3 > Category4 > Category5", "AnotherCategory0 > ... > AnotherCategory5 > AnotherCategory6" });
