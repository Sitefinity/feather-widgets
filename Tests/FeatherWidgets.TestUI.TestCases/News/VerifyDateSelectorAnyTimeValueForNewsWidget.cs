...
{
    /// <summary>
    /// VerifyDateSelectorAnyTimeValueForNewsWidget_ test class.
    /// </summary>
    [TestClass]
    public class VerifyDateSelectorAnyTimeValueForNewsWidget_ : FeatherTestCase
    {
        /// <summary>
        /// UI test VerifyDateSelectorAnyTimeValueForNewsWidget
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam7),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.News)]
        public void VerifyDateSelectorAnyTimeValueForNewsWidget()
        {
        ...
        private const string DateValueAnyTime = "Any time";
