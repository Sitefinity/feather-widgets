...
{
    /// <summary>
    /// VerifyUseLimitListSettingsOnFrontendPageForSearchResultsWidget_ test class.
    /// </summary>
    [TestClass]
    public class VerifyUseLimitListSettingsOnFrontendPageForSearchResultsWidget_ : FeatherTestCase
    {
        /// <summary>
        /// UI test VerifyUseLimitListSettingsOnFrontendPageForSearchResultsWidget
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam4),
        TestCategory(FeatherTestCategories.PagesAndContent),
        TestCategory(FeatherTestCategories.Search)]
        public void VerifyUseLimitListSettingsOnFrontendPageForSearchResultsWidget()
        {
            ...
            BATFeather.Wrappers().Frontend().Search().SearchWrapper().VerifySearchResultsList(NewsTitle5, NewsTitle4, NewsTitle3);
            Assert.IsFalse(BATFeather.Wrappers().Frontend().CommonWrapper().AreTitlesPresentOnThePageFrontend(new string[] { NewsTitle2, NewsTitle1 }));
            BAT.Macros().NavigateTo().Pages(this.Culture);
        }
