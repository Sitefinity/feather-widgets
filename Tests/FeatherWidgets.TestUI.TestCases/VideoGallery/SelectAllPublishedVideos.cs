...
namespace FeatherWidgets.TestUI.TestCases.VideoGallery
{
    ...
    public class SelectAllPublishedVideos_ : FeatherTestCase
    {
        ...
        public void SelectAllPublishedVideos()
        {
            ...
            BATFeather.Wrappers().Frontend().VideoGallery().VideoGalleryWrapper().VerifyVideo(scr, this.Culture);
        ...
        private string GetVideoSource(bool isBaseUrlIncluded, string videoName, string videoType)
        {
            ...
            string scr = BATFeather.Wrappers().Frontend().MediaWidgets().MediaWidgetsWrapper().GetMediaSource(isBaseUrlIncluded, libraryUrl, videoUrl, this.BaseUrl, "videos", currentProviderUrlName, this.Culture);
            return scr;
        }
        ...
        private string GetVideoHref(bool isBaseUrlIncluded, string videoName)
        {
            ...
            string href = BATFeather.Wrappers().Frontend().MediaWidgets().MediaWidgetsWrapper().GetMediaSource(isBaseUrlIncluded, libraryUrl, videoUrl, this.BaseUrl, PageName.ToLower() + "/videos", currentProviderUrlName, this.Culture);
            return href;
        }
