...
{
    /// <summary>
    /// VerifyNoLimitAndPaginationListSettingsOnFrontendPageForVideoGalleryWidget_ test class.
    /// </summary>
    [TestClass]
    public class VerifyNoLimitAndPaginationListSettingsOnFrontendPageForVideoGalleryWidget_ : FeatherTestCase
    {
        /// <summary>
        /// UI test VerifyNoLimitAndPaginationListSettingsOnFrontendPageForVideoGalleryWidget
        /// </summary>
        [TestMethod,
        ...
        public void VerifyNoLimitAndPaginationListSettingsOnFrontendPageForVideoGalleryWidget()
        {
            ...
            Assert.IsTrue(BATFeather.Wrappers().Frontend().VideoGallery().VideoGalleryWrapper().AreVideoTitlesPresentOnThePageFrontend(new string[] { VideoTitles5, VideoTitles4, VideoTitles3, VideoTitles2, VideoTitles1 }));
            BAT.Macros().NavigateTo().Pages(this.Culture);
        }
