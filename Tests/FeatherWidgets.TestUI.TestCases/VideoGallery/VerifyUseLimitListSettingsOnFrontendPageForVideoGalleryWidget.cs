...
{
    /// <summary>
    /// VerifyUseLimitListSettingsOnFrontendPageForVideoGalleryWidget_ test class.
    /// </summary>
    [TestClass]
    public class VerifyUseLimitListSettingsOnFrontendPageForVideoGalleryWidget_ : FeatherTestCase
    {
        /// <summary>
        /// UI test VerifyUseLimitListSettingsOnFrontendPageForVideoGalleryWidget
        /// </summary>
        [TestMethod,
        Owner(FeatherTeams.SitefinityTeam7),
        TestCategory(FeatherTestCategories.PagesAndContent), 
        TestCategory(FeatherTestCategories.VideoGallery)]
        public void VerifyUseLimitListSettingsOnFrontendPageForVideoGalleryWidget()
        {
